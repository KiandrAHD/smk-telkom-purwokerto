...
const PengumumanModal = ({ title, onClose, children, size = 'max-w-2xl' }) => (
  <div
  ...
  >
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="pengumuman-modal-title"
    >
      <div className="flex items-center justify-between border-b border-dark-100 px-5 py-4 sm:px-6">
        <h2 id="pengumuman-modal-title" className="font-heading text-lg font-extrabold text-dark-900">
          {title}
        </h2>
        <button
          type="button"
          onClick={onClose}
          className="rounded-lg p-2 text-dark-400 transition-colors hover:bg-dark-50 hover:text-dark-700"
