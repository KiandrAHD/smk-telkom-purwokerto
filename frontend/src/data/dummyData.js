...
export const ekstrakurikulerData = {
  ...
  items: [
    { title: 'OSIS', category: 'Organisasi', description: 'OSIS SMK Telkom Purwokerto, yang akrab disebut dengan nama OSISTEL, merupakan lembaga eksekutif siswa tertinggi di lingkungan SMK Telkom Purwokerto.', image: kegiatanEkskul1 },
    { title: 'Pramuka', category: 'Organisasi', description: 'Pramuka SMK Telkom Purwokerto adalah ekstrakurikuler wajib yang dikelola oleh Ambalan Gajahmada & Srikandi (Gamakandi). Kegiatan ini bertujuan untuk melatih kedisiplinan, kepemimpinan, dan kemandirian siswa.', image: kegiatanEkskul2 },
    { title: 'PMR', category: 'Organisasi', description: 'PMR (Palang Merah Remaja) SMK Telkom Purwokerto adalah organisasi ekstrakurikuler sekolah yang bergerak di bidang kemanusiaan, kesehatan, dan kepalangmerahan.', image: kegiatanEkskul3 },
    { title: 'MPK', category: 'Organisasi', description: 'MPK (Majelis Perwakilan Kelas) SMK Telkom Purwokerto adalah organisasi siswa tertinggi yang berfungsi sebagai lembaga legislatif di sekolah.', image: kegiatanEkskul4 },
    { title: 'Futsal', category: 'Prestasi', description: 'Tim Futsal SMK Telkom Purwokerto aktif sebagai wadah pengembangan bakat olahraga siswa dan kerap menorehkan prestasi di berbagai kompetisi tingkat regional.', image: kegiatanEkskul1 },
    { title: 'Basket', category: 'Prestasi', description: 'Ekstrakurikuler Basket SMK Telkom Purwokerto adalah wadah bagi siswa untuk mengembangkan bakat, fisik, dan prestasi di cabang olahraga bola basket.', image: kegiatanEkskul2 },
    { title: 'Robotik', category: 'Prestasi', description: 'Ekstrakurikuler Robotik SMK Telkom Purwokerto merupakan program kejuruan unggulan untuk mengasah keahlian masa depan di bidang otomasi dan teknologi digital.', image: kegiatanEkskul3 },
    { title: 'E-Sport', category: 'Prestasi', description: 'Ekstrakurikuler E-Sport SMK Telkom Purwokerto merupakan wadah resmi bagi siswa yang tertarik mengembangkan bakat di dunia gim kompetitif dan industri kreatif digital.', image: kegiatanEkskul4 },
    { title: 'Wirausaha', category: 'Sentra', description: 'Ekstrakurikuler Wirausaha di SMK Telkom Purwokerto secara resmi diwadahi melalui Sentra Kewirausahaan serta program inkubasi bisnis sekolah.', image: kegiatanEkskul1 },
    { title: 'PIK-R', category: 'Sentra', description: 'PIK-R Satria adalah wadah resmi bagi siswa untuk saling berbagi, berkonsultasi, dan mendapatkan edukasi mengenai kehidupan remaja.', image: kegiatanEkskul2 },
    { title: 'ROHIS', category: 'Sentra', description: 'ROHIS SMK Telkom Purwokerto adalah organisasi keagamaan sekolah yang berfungsi sebagai pusat syiar Islam, pembinaan akhlak, serta pengembangan karakter religius siswa.', image: kegiatanEkskul3 },
    { title: 'ROHKRIS', category: 'Sentra', description: 'ROHKRIS SMK Telkom Purwokerto adalah wadah pembinaan kerohanian resmi bagi siswa yang beragama Kristen dan Katolik.', image: kegiatanEkskul4 },
    { title: 'Brand Ambassador', category: 'Community', description: 'Brand Ambassador SMK Telkom Purwokerto adalah program resmi sekolah untuk memilih siswa-siswi terbaik sebagai wajah dan representasi sekolah.', image: kegiatanEkskul1 },
    { title: 'Team Konten', category: 'Community', description: 'Tim Konten adalah tim kreatif resmi sekolah yang mengelola, memproduksi, dan menyusun strategi komunikasi digital pada akun media sosial sekolah.', image: kegiatanEkskul2 },
    { title: 'Stematel ART', category: 'Community', description: 'Stematel ART adalah salah satu pilar pengembangan bakat siswa yang ingin mendalami industri kreatif, seni digital, dan desain visual modern.', image: kegiatanEkskul3 },
    { title: 'Stematel Reader', category: 'Community', description: 'Komunitas literasi resmi SMK Telkom Purwokerto yang bergerak dalam membangun budaya membaca, menulis, dan berkarya secara modern dan digital.', image: kegiatanEkskul4 },
  ],
};
