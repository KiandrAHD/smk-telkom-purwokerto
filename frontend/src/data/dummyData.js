...
import organisasiPaskibra from '../assets/ekstrakurikuler/organisasi/paskibra.jpg';
import organisasiPikRSatria from '../assets/ekstrakurikuler/organisasi/pik-r-satria.jpg';
import organisasiPramuka from '../assets/ekstrakurikuler/organisasi/pramuka.jpg';
import organisasiRohis from '../assets/ekstrakurikuler/organisasi/rohis.jpg';
...
export const ekstrakurikulerData = {
  ...
  items: [
    { title: 'OSIS', category: 'Organisasi', description: 'OSIS SMK Telkom Purwokerto, yang akrab disebut dengan nama OSISTEL, merupakan lembaga eksekutif siswa tertinggi di lingkungan SMK Telkom Purwokerto.', focus: ['Kepemimpinan', 'Penyusunan program kerja', 'Komunikasi organisasi', 'Manajemen kegiatan'], image: organisasiOsis },
    { title: 'Pramuka', category: 'Organisasi', description: 'Pramuka SMK Telkom Purwokerto adalah ekstrakurikuler wajib yang dikelola oleh Ambalan Gajahmada & Srikandi (Gamakandi). Kegiatan ini bertujuan untuk melatih kedisiplinan, kepemimpinan, dan kemandirian siswa.', focus: ['Kedisiplinan', 'Kemandirian', 'Kepemimpinan', 'Keterampilan lapangan'], image: organisasiPramuka },
    ...
    { title: 'MPK', category: 'Organisasi', description: 'MPK (Majelis Perwakilan Kelas) SMK Telkom Purwokerto adalah organisasi siswa tertinggi yang berfungsi sebagai lembaga legislatif di sekolah.', focus: ['Penyaluran aspirasi', 'Musyawarah', 'Pengawasan program', 'Tanggung jawab'], image: organisasiMpk },
    { title: 'Paskibra', category: 'Organisasi', description: 'Paskibra menjadi wadah bagi siswa untuk berlatih baris-berbaris dan menjalankan tugas pengibaran bendera. Kegiatannya melatih disiplin, kekompakan, dan tanggung jawab.', focus: ['Baris-berbaris', 'Tata upacara', 'Disiplin', 'Kerja sama tim'], image: organisasiPaskibra },
    ...
    { title: 'ROHIS', category: 'Sentra', description: 'ROHIS SMK Telkom Purwokerto adalah organisasi keagamaan sekolah yang berfungsi sebagai pusat syiar Islam, pembinaan akhlak, serta pengembangan karakter religius siswa.', focus: ['Pembinaan akhlak', 'Kegiatan keagamaan', 'Kepemimpinan', 'Kepedulian sosial'], image: organisasiRohis },
