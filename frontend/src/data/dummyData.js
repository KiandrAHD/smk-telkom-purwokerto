...
export const ekstrakurikulerData = {
  ...
  items: [
    { title: 'OSIS', category: 'Organisasi', description: 'OSIS SMK Telkom Purwokerto, yang akrab disebut dengan nama OSISTEL, merupakan lembaga eksekutif siswa tertinggi di lingkungan SMK Telkom Purwokerto.', focus: ['Kepemimpinan', 'Penyusunan program kerja', 'Komunikasi organisasi', 'Manajemen kegiatan'], image: kegiatanEkskul1 },
    { title: 'Pramuka', category: 'Organisasi', description: 'Pramuka SMK Telkom Purwokerto adalah ekstrakurikuler wajib yang dikelola oleh Ambalan Gajahmada & Srikandi (Gamakandi). Kegiatan ini bertujuan untuk melatih kedisiplinan, kepemimpinan, dan kemandirian siswa.', focus: ['Kedisiplinan', 'Kemandirian', 'Kepemimpinan', 'Keterampilan lapangan'], image: kegiatanEkskul2 },
    { title: 'PMR', category: 'Organisasi', description: 'PMR (Palang Merah Remaja) SMK Telkom Purwokerto adalah organisasi ekstrakurikuler sekolah yang bergerak di bidang kemanusiaan, kesehatan, dan kepalangmerahan.', focus: ['Pertolongan pertama', 'Kesehatan remaja', 'Kepedulian sosial', 'Kerja tim'], image: kegiatanEkskul3 },
    { title: 'MPK', category: 'Organisasi', description: 'MPK (Majelis Perwakilan Kelas) SMK Telkom Purwokerto adalah organisasi siswa tertinggi yang berfungsi sebagai lembaga legislatif di sekolah.', focus: ['Penyaluran aspirasi', 'Musyawarah', 'Pengawasan program', 'Tanggung jawab'], image: kegiatanEkskul4 },
    { title: 'Paskibra', category: 'Organisasi', description: 'Paskibra menjadi wadah bagi siswa untuk berlatih baris-berbaris dan menjalankan tugas pengibaran bendera. Kegiatannya melatih disiplin, kekompakan, dan tanggung jawab.', focus: ['Baris-berbaris', 'Tata upacara', 'Disiplin', 'Kerja sama tim'], image: kegiatanEkskul1 },
    { title: 'Futsal', category: 'Prestasi', description: 'Tim Futsal SMK Telkom Purwokerto aktif sebagai wadah pengembangan bakat olahraga siswa dan kerap menorehkan prestasi di berbagai kompetisi tingkat regional.', focus: ['Teknik dasar futsal', 'Strategi permainan', 'Kebugaran fisik', 'Sportivitas'], image: kegiatanEkskul1 },
    { title: 'Basket', category: 'Prestasi', description: 'Ekstrakurikuler Basket SMK Telkom Purwokerto adalah wadah bagi siswa untuk mengembangkan bakat, fisik, dan prestasi di cabang olahraga bola basket.', focus: ['Teknik dasar basket', 'Strategi tim', 'Koordinasi tubuh', 'Sportivitas'], image: kegiatanEkskul2 },
    { title: 'Robotik', category: 'Prestasi', description: 'Ekstrakurikuler Robotik SMK Telkom Purwokerto merupakan program kejuruan unggulan untuk mengasah keahlian masa depan di bidang otomasi dan teknologi digital.', focus: ['Elektronika dasar', 'Pemrograman', 'Otomasi', 'Pemecahan masalah'], image: kegiatanEkskul3 },
    { title: 'E-Sport', category: 'Prestasi', description: 'Ekstrakurikuler E-Sport SMK Telkom Purwokerto merupakan wadah resmi bagi siswa yang tertarik mengembangkan bakat di dunia gim kompetitif dan industri kreatif digital.', focus: ['Strategi permainan', 'Komunikasi tim', 'Pengambilan keputusan', 'Sportivitas digital'], image: kegiatanEkskul4 },
    { title: 'Desain Grafis', category: 'Prestasi', description: 'Kegiatan ini mengembangkan kemampuan siswa membuat karya visual dengan prinsip desain dan perangkat digital. Siswa berlatih menyusun elemen visual untuk menyampaikan pesan secara menarik.', focus: ['Komposisi visual', 'Tipografi', 'Warna', 'Desain digital'], image: kegiatanEkskul1 },
    ...
    { title: 'AI / Artificial Intelligence', category: 'Prestasi', description: 'Siswa mengenal konsep dasar kecerdasan buatan dan mencoba penerapannya melalui proyek sederhana. Kegiatan juga membahas penggunaan AI secara kritis dan bertanggung jawab.', focus: ['Konsep AI', 'Data', 'Model sederhana', 'Etika AI'], image: kegiatanEkskul3 },
    ...
    { title: 'Information Network Cabling (INC)', category: 'Prestasi', description: 'Siswa mempelajari dasar penataan kabel dan koneksi jaringan komputer. Kegiatan praktik membantu memahami pemasangan, pengujian, dan perawatan jaringan secara aman.', focus: ['Jenis kabel jaringan', 'Konektor', 'Pemasangan kabel', 'Pengujian koneksi'], image: kegiatanEkskul2 },
    { title: '3D Game Art (Animasi)', category: 'Prestasi', description: 'Kegiatan ini mengembangkan keterampilan membuat aset visual tiga dimensi dan animasi untuk gim. Siswa berlatih mengolah ide menjadi karakter atau objek digital.', focus: ['Dasar pemodelan 3D', 'Desain karakter', 'Animasi', 'Aset gim'], image: kegiatanEkskul3 },
    { title: 'Bulu Tangkis', category: 'Prestasi', description: 'Ekskul ini menjadi tempat siswa berlatih teknik dan strategi permainan bulu tangkis. Latihan membantu meningkatkan kebugaran, koordinasi, dan sportivitas.', focus: ['Servis dan pukulan', 'Gerak kaki', 'Strategi permainan', 'Sportivitas'], image: kegiatanEkskul4 },
    ...
    { title: 'Wirausaha', category: 'Sentra', description: 'Ekstrakurikuler Wirausaha di SMK Telkom Purwokerto secara resmi diwadahi melalui Sentra Kewirausahaan serta program inkubasi bisnis sekolah.', focus: ['Ide bisnis', 'Perencanaan usaha', 'Pemasaran', 'Pengelolaan keuangan dasar'], image: kegiatanEkskul1 },
    { title: 'PIK-R', category: 'Sentra', description: 'PIK-R Satria adalah wadah resmi bagi siswa untuk saling berbagi, berkonsultasi, dan mendapatkan edukasi mengenai kehidupan remaja.', focus: ['Konseling sebaya', 'Komunikasi sehat', 'Perencanaan masa depan', 'Edukasi remaja'], image: kegiatanEkskul2 },
    { title: 'ROHIS', category: 'Sentra', description: 'ROHIS SMK Telkom Purwokerto adalah organisasi keagamaan sekolah yang berfungsi sebagai pusat syiar Islam, pembinaan akhlak, serta pengembangan karakter religius siswa.', focus: ['Pembinaan akhlak', 'Kegiatan keagamaan', 'Kepemimpinan', 'Kepedulian sosial'], image: kegiatanEkskul3 },
