...
const PengumumanBantuanCard = () => (
  <div className="relative min-h-[210px] overflow-hidden rounded-xl bg-[#ffc9ce] p-4 shadow-card">
    <h2 className="font-heading text-base font-extrabold text-[#bf0d1b]">
      {butuhBantuan.title}
    </h2>
    ...
    <Link
      to="/stela"
      className="relative z-10 mt-5 inline-flex items-center gap-2 rounded-lg bg-white px-3.5 py-2 font-heading text-[11px] font-extrabold text-primary shadow-sm transition-colors hover:bg-primary-50"
    >
